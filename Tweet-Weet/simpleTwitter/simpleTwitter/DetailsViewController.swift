...
//  simpleTwitter
//
//  Created by Ambrish Verma on 2/20/15.
...
class DetailsViewController: UIViewController {
    ...
    func addRightButton(){
        ...
        replyButton.setTitleTextAttributes([NSFontAttributeName: UIFont(name: "Helvetica Neue", size: 12)!], forState: UIControlState.Normal)
