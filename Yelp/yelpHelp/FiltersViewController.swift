...
//  yelpHelp
//
//  Created by Ambrish Verma on 2/12/15.
...
class FiltersViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, FilterTableViewCellDelegate, SortTableViewCellDelegate, PriceTableViewCellDelegate, RadiusTableViewCellDelegate, DealsTableViewCellDelegate {
    ...
    func filters() -> NSDictionary{
        ...
        results.setObject(priceSelected, forKey: "price_filter")
        return results;
    }
    ...
    override func viewDidLoad() {
        ...
        applyButton.setTitleTextAttributes([NSFontAttributeName: UIFont(name: "Helvetica Neue", size: 12)!], forState: UIControlState.Normal)
